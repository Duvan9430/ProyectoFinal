...
<ul id="menu-side" class="sidenav">
	...
	<li><a class="waves-effect waves-teal" href="../aprendiz/pagAprendizFrm.php"><i class="material-icons">person</i>Instructor</a></li>
	<li><a class="waves-effect waves-teal" href="../aprendiz/pagAprendizFrm.php"><i class="material-icons">person</i>Aprendiz</a></li>
	<li><a class="waves-effect waves-orange" href="../gimnasio/pagGimnasioFrm.php"><i class="material-icons">fitness_center</i>Gimnasio</a></li>
	<li><a class="waves-effect waves-green" href="#"><i class="material-icons">games</i>Control de Rutinas</a></li>
	<li><a class="waves-effect waves-orange" href="../eventos/pagEventosFrm.php"><i class="material-icons">event</i>Eventos</a></li>
	<br>
	<br>
	<br>
	<br>
